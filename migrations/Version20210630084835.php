 ...
 */
final class Version20210630084835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__collaborateur AS SELECT id, user_id, nom, prenom, date_naissance, date_entree_entreprise, type_contrat, date_heure_derniere_connexion, duree_travail_hebdo, num_securite_social, is_actif FROM collaborateur');
        $this->addSql('DROP TABLE collaborateur');
        $this->addSql('CREATE TABLE collaborateur (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, nom VARCHAR(255) NOT NULL COLLATE BINARY, prenom VARCHAR(255) NOT NULL COLLATE BINARY, date_naissance DATE NOT NULL, date_entree_entreprise DATE NOT NULL, type_contrat VARCHAR(255) NOT NULL COLLATE BINARY, date_heure_derniere_connexion DATETIME DEFAULT NULL, duree_travail_hebdo VARCHAR(255) NOT NULL COLLATE BINARY, num_securite_social VARCHAR(255) NOT NULL COLLATE BINARY, is_actif BOOLEAN DEFAULT NULL, CONSTRAINT FK_770CBCD3A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO collaborateur (id, user_id, nom, prenom, date_naissance, date_entree_entreprise, type_contrat, date_heure_derniere_connexion, duree_travail_hebdo, num_securite_social, is_actif) SELECT id, user_id, nom, prenom, date_naissance, date_entree_entreprise, type_contrat, date_heure_derniere_connexion, duree_travail_hebdo, num_securite_social, is_actif FROM __temp__collaborateur');
        ...
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, admin_id INTEGER DEFAULT NULL, collaborateur_id INTEGER DEFAULT NULL, login VARCHAR(180) NOT NULL COLLATE BINARY, password VARCHAR(255) NOT NULL COLLATE BINARY, roles CLOB NOT NULL --(DC2Type:array)
