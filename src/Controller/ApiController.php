...
final class ApiController extends AbstractController
{
    ...
    {//Cognitive complexity for "App\Controller\ApiController::majEvent()" is 17, keep it under 9
        ...
        if(//empty() is forbidden to use
            isset($donnees->title) && ($donnees->title !== null) &&
            isset($donnees->start) && ($donnees->start !== null) &&
            isset($donnees->description) && ($donnees->description !== null) &&
            isset($donnees->backgroundColor) && ($donnees->backgroundColor !== null) &&
            isset($donnees->borderColor) && ($donnees->borderColor !== null) &&
            isset($donnees->textColor) && ($donnees->textColor !== null) &&
            isset($donnees->allDay) && ($donnees->allDay !== null) && 
            isset($donnees->end) && ($donnees->end !== null)
